...
class BMU(DataPrep, EBModels, SurrModels):
    ...
    def nmse(self, e):
        ...
        nmse = (100/(self.data.std()*len(self.data)))*np.sqrt((self.fwd_model.forward(e=e, dt=0)-self.data).T@(self.fwd_model.forward(e, dt=0)-self.data))
...
class DamageDiag(DataPrep, EBModels, SurrModels):
    ...
    def nmse(self, dt):
        ...
        nmse = (100/(self.data.std()*len(self.data)))*np.sqrt((self.fwd_model.forward(e=self.ym, dt=dt)-self.data).T@(self.fwd_model.forward(e=self.ym, dt=dt)-self.data))
...
class StructDetMon(DataPrep, EBModels, SurrModels):
    ...
    def nmse(self, str_post, obs):
        ...
        nmse = (100/(obs.std()*len(obs)))*np.sqrt((str_post-obs).T@(str_post-obs))
